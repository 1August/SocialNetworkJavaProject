    ...
    return function i(s, a, l) {
        ...
        12: [function (t, e, n) {
            ...
            var r = t("events").EventEmitter, o = t("inherits"), i = t("./utils/url"), s = t("./transport/sender/xdr"),
                ...
                u = t("./transport/sender/xhr-fake"), c = t("./info-iframe"), f = t("./info-ajax"), h = function () {
                };
        ...
        14: [function (_, E, t) {
            (function (i) {
                "use strict";
                _("./shims");
                var r, l = _("url-parse"), t = _("inherits"), s = _("json3"), u = _("./utils/random"),
                    e = _("./utils/escape"), c = _("./utils/url"), a = _("./utils/event"), n = _("./utils/transport"),
        ...
        15: [function (t, e, n) {
            ...
            d(r, {
                bind: function (e) {
                    ...
                    for (var r = u.call(arguments, 1), t = Math.max(0, n.length - r.length), o = [], i = 0; i < t; i++) o.push("$" + i);
            ...
            }, (v = c.forEach, y = b = !0, v && (v.call("foo", function (t, e, n) {
                "object" != typeof n && (b = !1)
            }), v.call([1], function () {
            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1], s.split = function (t, e) {
                ...
                for (t = new RegExp(t.source, l + "g"), n += "", _ || (r = new RegExp("^" + t.source + "$(?!\\s)", l)), e = void 0 === e ? -1 >>> 0 : function (t) {
                    return t >>> 0
                }(e); (o = t.exec(n)) && !(u < (i = o.index + o[0].length) && (a.push(n.slice(u, o.index)), !_ && 1 < o.length && o[0].replace(r, function () {
                    for (var t = 1; t < arguments.length - 2; t++) void 0 === arguments[t] && (o[t] = void 0)
                }), 1 < o.length && o.index < n.length && c.push.apply(a, o.slice(1)), s = o[0].length, u = i, a.length >= e));) t.lastIndex === o.index && t.lastIndex++;
                return u === n.length ? !s && t.test("") || a.push("") : a.push(n.slice(u)), a.length > e ? a.slice(0, e) : a
        ...
        17: [function (o, f, t) {
            (function (t) {
                ...
                var i = o("events").EventEmitter, e = o("inherits"), s = o("../../utils/event"),
                    a = o("../../utils/url"), l = t.XMLHttpRequest, u = function () {
                    };
                ...
                e(c, i), c.prototype._start = function (t, e, n, r) {
                    var o = this;
                    try {
                        this.xhr = new l
                    } catch (t) {
                        ...
                        if (o.xhr) {
                            ...
                            switch (u("readyState", n.readyState), n.readyState) {
                                case 3:
                                    ...
                                    u("status", e), 1223 === e && (e = 204), 200 === e && t && 0 < t.length && (u("chunk"), o.emit("chunk", e, t));
                                    break;
                                case 4:
                                    e = n.status, u("status", e), 1223 === e && (e = 204), 12005 !== e && 12029 !== e || (e = 0), u("finish", e, n.responseText), o.emit("finish", e, n.responseText), o._cleanup(!1)
                            }
                        }
                    };
                    try {
                ...
                !c.enabled && n in t && (u("overriding xmlhttprequest"), c.enabled = !!new (l = function () {
                    try {
        ...
        22: [function (t, e, n) {
            ...
            var r = t("inherits"), o = t("json3"), i = t("events").EventEmitter, s = t("../version"),
                a = t("../utils/url"), l = t("../utils/iframe"), u = t("../utils/event"), c = t("../utils/random"),
                f = function () {
                };
            ...
            function h(t, e, n) {
                ...
                i.call(this);
                var r = this;
                this.origin = a.getOrigin(n), this.baseUrl = n, this.transUrl = e, this.transport = t, this.windowId = c.string(8);
        ...
        28: [function (t, e, n) {
            "use strict";
            var r = t("inherits"), a = t("../../utils/url"), l = t("./buffered-sender"), u = t("./polling"),
                c = function () {
                };
            ...
            function o(t, e, n, r, o) {
                ...
                c(i);
                var s = this;
                l.call(this, t, n), this.poll = new u(r, i, o), this.poll.on("message", function (t) {
                    c("poll message", t), s.emit("message", t)
                }), this.poll.once("close", function (t, e) {
                    c("poll close", t, e), s.poll = null, s.emit("close", t, e), s.close()
                })
            }
        ...
        30: [function (n, c, t) {
            (function (r) {
                ...
                function u(t) {
                    l(t), s.call(this);
                    var e = this;
                    o.polluteGlobalNamespace(), this.id = "a" + a.string(6), t = i.addQuery(t, "c=" + decodeURIComponent(o.WPrefix + "." + this.id)), l("using htmlfile", u.htmlfileEnabled);
                ...
                t(u, s), u.prototype.abort = function () {
        ...
        31: [function (e, n, t) {
            (function (i) {
                ...
                var r = e("../../utils/iframe"), s = e("../../utils/random"), a = e("../../utils/browser"),
                    o = e("../../utils/url"), t = e("inherits"), l = e("events").EventEmitter, u = function () {
                    };
                ...
                t(c, l), c.prototype.abort = function () {
                    ...
                    u("_callback", t), this._cleanup(), this.aborting || (t && (u("message", t), this.emit("message", t)), this.emit("close", null, "network"), this.removeAllListeners())
                }, c.prototype._abort = function (t) {
                    u("_abort", t), this._cleanup(), this.aborting = !0, this.emit("close", t.code, t.message), this.removeAllListeners()
        ...
        33: [function (t, e, n) {
            (function (s) {
                ...
                e.exports = function (t, e, n) {
                    ...
                    var r = "a" + u.string(8);
                    a.target = r, a.action = c.addQuery(c.addPath(t, "/jsonp_send"), "i=" + r);
                    var o = function (e) {
                        f("createIframe", e);
                        try {
        ...
        34: [function (r, u, t) {
            (function (i) {
                ...
                }, n.enabled = !(!i.XDomainRequest || !e.hasDomain()), u.exports = n
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {
            "../../utils/browser": 44,
            "../../utils/event": 46,
        ...
        38: [function (t, e, n) {
            ...
            var i = t("../utils/event"), s = t("../utils/url"), r = t("inherits"), a = t("events").EventEmitter,
                l = t("./driver/websocket"), u = function () {
                };
            ...
            r(c, a), c.prototype.send = function (t) {
                var e = "[" + t + "]";
        ...
        42: [function (l, u, t) {
            (function (t) {
                ...
                }, a.transportName = "xhr-streaming", a.roundTrips = 2, a.needBody = !!t.document, u.exports = a
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {
            "../utils/browser": 44,
            "./lib/ajax-based": 24,
            ...
            (function (f) {
                ...
                p.exports = {
                    WPrefix: "_jp", currentWindowId: null, polluteGlobalNamespace: function () {
                        ...
                        return u.body.appendChild(c), a = u.createElement("iframe"), c.appendChild(a), a.src = t, a.onerror = function () {
                            o("onerror")
        ...
        55: [function (t, a, l) {
            (function (s) {
                (function () {
                    var J = {"function": !0, "object": !0}, t = J[typeof l] && l && !l.nodeType && l,
                    ...
                    function F(t, l) {
                        ...
                        var u = t.Number || B.Number, c = t.String || B.String, e = t.Object || B.Object,
                            v = t.Date || B.Date, n = t.SyntaxError || B.SyntaxError, b = t.TypeError || B.TypeError,
                            d = t.Math || B.Math, r = t.JSON || B.JSON;
                        ...
                        function f(t) {
                            ...
                            var e;
                            if ("bug-string-char-index" == t) e = "a" != "a"[0]; else if ("json" == t) e = f("json-stringify") && f("date-serialization") && f("json-parse"); else if ("date-serialization" == t) {
                        ...
                        if (w(function () {
                            ...
                            var h = "[object Function]", x = "[object Number]", _ = "[object String]",
                                E = "[object Array]", m = f("bug-string-char-index"), j = function (t, e) {
                                    var n, s, r, o = 0;
                                    for (r in (n = function () {
                                        this.valueOf = 0
                                    }).prototype.valueOf = 0, s = new n) a.call(s, r) && o++;
                                    return n = s = null, (j = o ? function (t, e) {
                                        var n, r, o = g.call(t) == h;
                                        for (n in t) o && "prototype" == n || !a.call(t, n) || (r = "constructor" === n) || e(n);
                                        ...
                                        var n, r, o = g.call(t) == h,
                                            i = !o && "function" != typeof t.constructor && J[typeof t.hasOwnProperty] && t.hasOwnProperty || a;
                            ...
                            if (!f("json-stringify") && !f("date-serialization")) {
                                ...
                                var i = {92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t"},
                                    T = function (t) {
                                        ...
                                        if (p) e = function (t) {
                                            n = t.getUTCFullYear(), r = t.getUTCMonth(), o = t.getUTCDate(), s = t.getUTCHours(), a = t.getUTCMinutes(), l = t.getUTCSeconds(), u = t.getUTCMilliseconds()
                                        }; else {
                                            function c(t, e) {
                                            ...
                                            e = function (t) {
                                                for (o = f(t / 864e5), n = f(o / 365.2425) + 1970 - 1; c(n + 1, 0) <= o; n++) ;
                                                for (r = f((o - c(n, 0)) / 30.42); c(n, r + 1) <= o; r++) ;
                                                o = 1 + o - c(n, r), s = f((i = (t % 864e5 + 864e5) % 864e5) / 36e5) % 24, a = f(i / 6e4) % 60, l = f(i / 1e3) % 60, u = i % 1e3
                                            }
                                        }
                                        return (T = function (t) {
                                            return -1 / 0 < t && t < 1 / 0 ? (e(t), t = (n <= 0 || 1e4 <= n ? (n < 0 ? "-" : "+") + S(6, n < 0 ? -n : n) : S(4, n)) + "-" + S(2, r + 1) + "-" + S(2, o) + "T" + S(2, s) + ":" + S(2, a) + ":" + S(2, l) + "." + S(3, u) + "Z", n = r = o = s = a = l = u = null) : t = null, t
                                        })(t)
                                    };
                                if (f("json-stringify") && !f("date-serialization")) {
                                    function s(t) {
                                    ...
                                    function C(t) {
                                        var e = t.charCodeAt(0), n = i[e];
                                        return n || "\\u00" + S(2, e.toString(16))
                                    }

                                    function A(t) {
                                        return N.lastIndex = 0, '"' + (N.test(t) ? t.replace(N, C) : t) + '"'
                                    }

                                    var N = /[\x00-\x1f\x22\x5c]/g, k = function (t, e, n, r, o, i, s) {
                                        var a, l, u, c, f, h, d, p, m;
                                        if (w(function () {
                                            a = e[t]
                                        }), "object" == typeof a && a && (a.getUTCFullYear && "[object Date]" == g.call(a) && a.toJSON === v.prototype.toJSON ? a = T(a) : "function" == typeof a.toJSON && (a = a.toJSON(t))), n && (a = n.call(e, t, a)), a == y) return a === y ? a : "null";
                                    ...
                                    l.stringify = function (t, e, n) {
                                        var r, o, i, s;
                                        if (J[typeof e] && e) if ((s = g.call(e)) == h) o = e; else if (s == E) {
                                            i = {};
                                            for (var a, l = 0, u = e.length; l < u;) a = e[l++], "[object String]" != (s = g.call(a)) && "[object Number]" != s || (i[a] = 1)
                                        }
                            ...
                            if (!f("json-parse")) {
                                ...
                                function L() {
                                    for (var t, e, n, r, o, i = U, s = i.length; R < s;) switch (o = i.charCodeAt(R)) {
                                        case 9:
                                        case 10:
                                        case 13:
                                        case 32:
                                        ...
                                        case 34:
                                            for (t = "@", R++; R < s;) if ((o = i.charCodeAt(R)) < 32) I(); else if (92 == o) switch (o = i.charCodeAt(++R)) {
                                                case 92:
                                                case 34:
                                                case 47:
                                                case 98:
                                                ...
                                                case 114:
                                                    ...
                                                    break;
                                                case 117:
                                                    for (e = ++R, n = R + 4; R < n; R++) 48 <= (o = i.charCodeAt(R)) && o <= 57 || 97 <= o && o <= 102 || 65 <= o && o <= 70 || I();
                                                    t += M("0x" + i.slice(e, R));
                                                    break;
                                                default:
                                                    I()
                                ...
                                var R, U, M = c.fromCharCode, q = {
                                    ...
                                    if ("$" == t && I(), "string" == typeof t) {
                                        ...
                                        if ("[" == t) {
                                            for (e = []; "]" != (t = L());) n ? "," == t ? "]" == (t = L()) && I() : I() : n = !0, "," == t && I(), e.push(D(t));
                                            return e
                                        }
                                        if ("{" == t) {
                                            for (e = {}; "}" != (t = L());) n ? "," == t ? "}" == (t = L()) && I() : I() : n = !0, "," != t && "string" == typeof t && "@" == (m ? t.charAt(0) : t[0]) && ":" == L() || I(), e[t.slice(1)] = D(L());
                                            return e
                                        }
                                        I()
                                    }
                                    ...
                                    var r, o = t[e];
                                    if ("object" == typeof o && o) if (g.call(o) == E) for (r = o.length; r--;) P(g, j, o); else j(o, function (t) {
                                        P(o, t, n)
                                    });
                                    return n.call(t, e, o)
                                };
                                l.parse = function (t, e) {
                                    var n, r;
                                    return R = 0, U = "" + t, n = D(L()), "$" != L() && I(), R = U = null, e && g.call(e) == h ? W(((r = {})[""] = n, r), "", e) : n
                                }
                            }
                        }
                    ...
                    if (!e || e.global !== e && e.window !== e && e.self !== e || (B = e), t) F(B, t); else {
        ...
        56: [function (t, e, n) {
            ...
            n.stringify = function (t, e) {
                e = e || "";
                var n, r, o = [];
                for (r in "string" != typeof e && (e = "?"), t) if (i.call(t, r)) {
                    if ((n = t[r]) || null != n && !isNaN(n) || (n = ""), r = encodeURIComponent(r), n = encodeURIComponent(n), null === r || null === n) continue;
                    o.push(r + "=" + n)
                }
        ...
        58: [function (t, n, e) {
            (function (i) {
                "use strict";
                var d = t("requires-port"), p = t("querystringify"), s = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//,
                    l = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i, m = /^[a-zA-Z]:/,
                ...
                function y(t) {
                    var e,
                        ...
                        r = {}, o = typeof (t = t || n);
                    if ("blob:" === t.protocol) r = new x(unescape(t.pathname), {}); else if ("string" == o) for (e in r = new x(t, {}), a) delete r[e]; else if ("object" == o) {
                ...
                function w(t, e) {
                    ...
                    return i ? a = s ? (n = r[2] + r[3] + r[4], r[2].length + r[3].length) : (n = r[2] + r[4], r[2].length) : s ? (n = r[3] + r[4], a = r[3].length) : n = r[4], "file:" === o ? 2 <= a && (n = n.slice(2)) : g(o) ? n = r[4] : o ? i && (n = n.slice(2)) : 2 <= a && g(e.protocol) && (n = r[4]), {
                        protocol: o,
                        slashes: i || g(o),
                        slashesCount: a,
                        rest: n
                ...
                function x(t, e, n) {
                    ...
                    }(f.pathname, e.pathname)), "/" !== f.pathname.charAt(0) && g(f.protocol) && (f.pathname = "/" + f.pathname), d(f.port, f.protocol) || (f.host = f.hostname, f.port = ""), f.username = f.password = "", f.auth && (s = f.auth.split(":"), f.username = s[0] || "", f.password = s[1] || ""), f.origin = "file:" !== f.protocol && g(f.protocol) && f.host ? f.protocol + "//" + f.host : "null", f.href = f.toString()
                }
                ...
                x.prototype = {
                    set: function (t, e, n) {
                        ...
                        return r.origin = "file:" !== r.protocol && g(r.protocol) && r.host ? r.protocol + "//" + r.host : "null", r.href = r.toString(), r
                    }, toString: function (t) {
                ...
                }, x.extractProtocol = w, x.location = y, x.trimLeft = v, x.qs = p, n.exports = x
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
